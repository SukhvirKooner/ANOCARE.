                ...
                <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">
                    <form onSubmit={sendEmail} id="demoProductForm">
                        <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                            <div className="flex">
                                <h1 className="font-bold text-center lg:text-left text-blue-900 uppercase text-4xl">Verify Your NGO</h1>
                            </div>
                        ...
                        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
                                ...
                                <div>
                                    <input
                                        ...
                                        className="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                                        type="text" 
                                        placeholder="FCRA Certificate link*"
                                        value={phone}
                        ...
                        <div className="my-4">
                            <textarea 
                                name="message" 
                                placeholder=" Key Objectives and Ongoing campaigns*" 
                        ...
                        <div className="flex flex-col text-white">     
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">Tel: 00000000</p>
